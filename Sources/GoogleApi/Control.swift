  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let methodPolicies = CodingKeys(stringValue: "methodPolicies")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MethodPolicy].self, forKey: .methodPolicies) {
      self.methodPolicies = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.methodPolicies, forKey: .methodPolicies)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.Control"
  }
