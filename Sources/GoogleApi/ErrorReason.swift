...
public enum ErrorReason: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("ERROR_REASON_UNSPECIFIED")
    case .serviceDisabled: return try container.encode("SERVICE_DISABLED")
    ...
    case .apiKeyServiceBlocked: return try container.encode("API_KEY_SERVICE_BLOCKED")
    case .rateLimitExceeded: return try container.encode("RATE_LIMIT_EXCEEDED")
    case .resourceQuotaExceeded: return try container.encode("RESOURCE_QUOTA_EXCEEDED")
    case .apiKeyHttpReferrerBlocked: return try container.encode("API_KEY_HTTP_REFERRER_BLOCKED")
    case .apiKeyIpAddressBlocked: return try container.encode("API_KEY_IP_ADDRESS_BLOCKED")
    case .apiKeyAndroidAppBlocked: return try container.encode("API_KEY_ANDROID_APP_BLOCKED")
    case .locationTaxPolicyViolated: return try container.encode("LOCATION_TAX_POLICY_VIOLATED")
    case .userProjectDenied: return try container.encode("USER_PROJECT_DENIED")
    case .consumerSuspended: return try container.encode("CONSUMER_SUSPENDED")
    case .apiKeyIosAppBlocked: return try container.encode("API_KEY_IOS_APP_BLOCKED")
    case .consumerInvalid: return try container.encode("CONSUMER_INVALID")
    case .securityPolicyViolated: return try container.encode("SECURITY_POLICY_VIOLATED")
    case .accessTokenExpired: return try container.encode("ACCESS_TOKEN_EXPIRED")
    case .accessTokenScopeInsufficient:
      return try container.encode("ACCESS_TOKEN_SCOPE_INSUFFICIENT")
    case .accountStateInvalid: return try container.encode("ACCOUNT_STATE_INVALID")
    case .accessTokenTypeUnsupported: return try container.encode("ACCESS_TOKEN_TYPE_UNSUPPORTED")
    case .credentialsMissing: return try container.encode("CREDENTIALS_MISSING")
    case .resourceProjectInvalid: return try container.encode("RESOURCE_PROJECT_INVALID")
    case .sessionCookieInvalid: return try container.encode("SESSION_COOKIE_INVALID")
    case .userBlockedByAdmin: return try container.encode("USER_BLOCKED_BY_ADMIN")
    case .resourceUsageRestrictionViolated:
      return try container.encode("RESOURCE_USAGE_RESTRICTION_VIOLATED")
    case .systemParameterUnsupported: return try container.encode("SYSTEM_PARAMETER_UNSUPPORTED")
    case .orgRestrictionViolation: return try container.encode("ORG_RESTRICTION_VIOLATION")
    case .orgRestrictionHeaderInvalid: return try container.encode("ORG_RESTRICTION_HEADER_INVALID")
    case .serviceNotVisible: return try container.encode("SERVICE_NOT_VISIBLE")
    case .gcpSuspended: return try container.encode("GCP_SUSPENDED")
    case .locationPolicyViolated: return try container.encode("LOCATION_POLICY_VIOLATED")
    case .missingOrigin: return try container.encode("MISSING_ORIGIN")
    case .overloadedCredentials: return try container.encode("OVERLOADED_CREDENTIALS")
    case .locationOrgPolicyViolated: return try container.encode("LOCATION_ORG_POLICY_VIOLATED")
    case .tlsOrgPolicyViolated: return try container.encode("TLS_ORG_POLICY_VIOLATED")
    case .emulatorQuotaExceeded: return try container.encode("EMULATOR_QUOTA_EXCEEDED")
    case .credentialAndroidAppInvalid: return try container.encode("CREDENTIAL_ANDROID_APP_INVALID")
    case .iamPermissionDenied: return try container.encode("IAM_PERMISSION_DENIED")
    case .jwtTokenInvalid: return try container.encode("JWT_TOKEN_INVALID")
    case .credentialTypeUnsupported: return try container.encode("CREDENTIAL_TYPE_UNSUPPORTED")
    case .accountTypeUnsupported: return try container.encode("ACCOUNT_TYPE_UNSUPPORTED")
    case .endpointUsageRestrictionViolated:
      return try container.encode("ENDPOINT_USAGE_RESTRICTION_VIOLATED")
    case .tlsCipherRestrictionViolated:
      return try container.encode("TLS_CIPHER_RESTRICTION_VIOLATED")
    case .mcpServerDisabled: return try container.encode("MCP_SERVER_DISABLED")
