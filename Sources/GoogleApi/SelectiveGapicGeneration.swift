  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let generateOmittedAsInternal = CodingKeys(stringValue: "generateOmittedAsInternal")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.Bool.self, forKey: .generateOmittedAsInternal)
    {
      self.generateOmittedAsInternal = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.generateOmittedAsInternal, forKey: .generateOmittedAsInternal)
