...
public enum ClientLibraryOrganization: Codable, Equatable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ClientLibraryOrganization/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ClientLibraryOrganization/unknownIntValue(_:)).
