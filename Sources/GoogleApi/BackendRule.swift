  ...
  Sendable
{
  ...
  public enum PathTranslation: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:PathTranslation/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:PathTranslation/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("PATH_TRANSLATION_UNSPECIFIED")
      case .constantAddress: return try container.encode("CONSTANT_ADDRESS")
      case .appendPathToAddress: return try container.encode("APPEND_PATH_TO_ADDRESS")
