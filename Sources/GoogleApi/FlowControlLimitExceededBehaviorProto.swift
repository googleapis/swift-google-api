...
public enum FlowControlLimitExceededBehaviorProto: Codable, Equatable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:FlowControlLimitExceededBehaviorProto/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:FlowControlLimitExceededBehaviorProto/unknownIntValue(_:)).
