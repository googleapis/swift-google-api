  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let providers = CodingKeys(stringValue: "providers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AuthenticationRule].self, forKey: .rules) {
      self.rules = value
    }
    if let value = try container.decodeIfPresent([AuthProvider].self, forKey: .providers) {
