...
public struct RoutingRule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let routingParameters = CodingKeys(stringValue: "routingParameters")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [RoutingParameter].self, forKey: .routingParameters)
    {
      self.routingParameters = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.routingParameters, forKey: .routingParameters)
