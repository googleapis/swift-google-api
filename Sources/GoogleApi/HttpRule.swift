  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let put = try container.decodeIfPresent(Swift.String.self, forKey: .put) {
      try patternCheckAndSet(.put(put))
    }
    if let post = try container.decodeIfPresent(Swift.String.self, forKey: .post) {
      try patternCheckAndSet(.post(post))
    }
    if let delete = try container.decodeIfPresent(Swift.String.self, forKey: .delete) {
      try patternCheckAndSet(.delete(delete))
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.additionalBindings, forKey: .additionalBindings)

    if let choice = self.pattern {
      switch choice {
      case .`get`(let value):
        try container.encode(value, forKey: .`get`)
      case .put(let value):
      ...
      case .patch(let value):
        try container.encode(value, forKey: .patch)
  ...
  public enum OneOf_Pattern: Codable, Equatable, Sendable {
    ...
    case put(Swift.String)
    /// Maps to HTTP POST. Used for creating a resource or performing an action.
    case post(Swift.String)
    /// Maps to HTTP DELETE. Used for deleting a resource.
    case delete(Swift.String)
    /// Maps to HTTP PATCH. Used for updating a resource.
    case patch(Swift.String)
