  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let subpages = CodingKeys(stringValue: "subpages")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Page].self, forKey: .subpages) {
      self.subpages = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.subpages, forKey: .subpages)
