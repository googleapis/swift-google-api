  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let metricRules = CodingKeys(stringValue: "metricRules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MetricRule].self, forKey: .metricRules) {
      self.metricRules = value
    }
